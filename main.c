/* Kernel Memcached
 *
 * Some inspiration for this file was taken from
 * http://kernelnewbies.org/Simple_UDP_Server and linux's net/ceph/messenger.c.
 *
 * This file is the main routene for kernelmemcached.  The initialization code
 ...
 */
#define MODULE_NAME "kernelmemcached"
...
/** Load the module */
int __init kernelmemcached_init(void)
{
    int ret;
 ...
 */
void __exit kernelmemcached_exit(void){
    struct list_head *p;
    close_listen_socket();
...
module_init(kernelmemcached_init);
module_exit(kernelmemcached_exit);

/* module information */
MODULE_DESCRIPTION("kernelmemcached");
MODULE_AUTHOR("Elijah Conners <business@elijahpepe.com>");
